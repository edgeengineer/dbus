...
struct DBusAuthenticationHandlerTests {
    ...
    @Test func rejectedAuthentication() throws {
        ...
        #expect(try channel.readOutbound(as: ByteBuffer.self) == nil, "No command should be sent after REJECTED")
    ...
    @Test func channelWritabilityChanges() throws {
        ...
        #expect(writabilityChangedBeforeAuth == true, "Writability tracker should detect change before auth")
    ...
    @Test func partialDataHandling() throws {
        ...
        #expect(try channel.readOutbound(as: ByteBuffer.self) == nil, "No command should be sent for partial response")
