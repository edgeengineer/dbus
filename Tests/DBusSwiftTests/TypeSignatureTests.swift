...
struct TypeSignatureTests {
    ...
    @Test func multipleBasicTypes() throws {
        ...
        try validateSignature("ybnqiuxtdsogvh", [
    ...
    @Test func complexTypes() throws {
        ...
        try validateSignature("a{sa{ia{ba{na{qa{ia(syv)}}}}}}", [
            .array(.dictEntry(
                key: .string,
                value: .array(.dictEntry(
                    key: .int32,
                    value: .array(.dictEntry(
                        key: .boolean,
                        value: .array(.dictEntry(
