...
struct DBusValueTests {
    ...
    @Test func int32Value() throws {
        let values: [Int32] = [0, 1, -1, 2147483647, -2147483648]
        for value in values {
    ...
    @Test func uint32Value() throws {
        let values: [UInt32] = [0, 1, 2147483647, 4294967295]
        for value in values {
    ...
    @Test func int64Value() throws {
        let values: [Int64] = [0, 1, -1, 9223372036854775807, -9223372036854775808]
        for value in values {
    ...
    @Test func uint64Value() throws {
        let values: [UInt64] = [0, 1, 9223372036854775807, 18446744073709551615]
        for value in values {
    ...
    @Test func doubleValue() throws {
        let values: [Double] = [0.0, 1.0, -1.0, 3.14159, Double.pi, Double.infinity, -Double.infinity, Double.nan]
        for value in values {
    ...
    @Test func unixFdValue() throws {
        let values: [UInt32] = [0, 1, 10, 4294967295]
        for value in values {
    ...
    @Test func complexNestedValue() throws {
        ...
        let complex = DBusValue.structure([
            ...
            .array([.int32(1), .int32(2), .int32(3)]),
            .dictionary([
                .string("metadata"): .variant(DBusVariant(
                    .structure([
                        .string("info"),
                        .boolean(true),
                        .double(3.14159)
                ...
                .string("tags"): .variant(DBusVariant(
    ...
    @Test func littleEndianSerialization() throws {
        let value = DBusValue.int32(0x12345678)
    ...
    func testRoundTripWithEndianness(_ value: DBusValue, _ typeSignature: String, _ endianness: Endianness) throws {
        ...
        do {
            let parsedValue = try DBusValue.parse(from: &readBuffer, typeSignature: typeSignature, byteOrder: endianness)
    ...
    @Test func signatureValidation() throws {
        ...
        for signature in signatures {
            ...
            let parsedValue = try DBusValue.parse(from: &readBuffer, typeSignature: signature, byteOrder: .little)
