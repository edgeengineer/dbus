    ...
    throws -> DBusValue
    {
        ...
        case "a":
            ...
            if elementSig.starts(with: "{") {
                ...
                while buffer.readerIndex < arrayEndPosition {
                    ...
                    let value = try DBusValue.parse(from: &buffer, typeSignature: valueType, byteOrder: byteOrder)
                    dict[key] = value
                }
        ...
        case "(":
            ...
            while !remaining.isEmpty {
                ...
                fields.append(try DBusValue.parse(from: &buffer, typeSignature: fieldSig, byteOrder: byteOrder))
            }
